        ...
        <div class="card-body card-block">
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="type" value="{{ old('type') ?? $item->type }}" class="form-control @error('type') is-invalid @enderror" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="quantity" value="{{ old('quantity') ?? $item->quantity }}" class="form-control @error('quantity') is-invalid @enderror" />
